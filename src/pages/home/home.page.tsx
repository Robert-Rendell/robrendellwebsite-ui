...
export const HomePage = () => {
  ...
  return (
    <div className="standard-page-margins standard-page-styling">
      ...
      <ul>
        <li>30/10/22 @ 10.33 - Completed <a href="photos-ive-taken/nature/wild-flowers">My Flower Photographs</a> project</li>
        <li>30/10/22 @ 10.01 - Completed <a href="climate-change/">Climate Change</a> project</li>
