  ...
  return (
    <>
      <div className="standard-page-margins standard-page-styling">
        ...
        <hr/>
        <p>
          The <NewTabLink href="https://en.wikipedia.org/wiki/Mandelbrot_set">Mandelbrot set</NewTabLink> fractal is generated from a very simple equation:
        </p>
        <Equation>
        ...
        <hr/>
        <p>
            The rules of Conway&apos;s Game of Life (2D environment) are, strangely, also very simple - despite the incredible
            diversity of creatures (patterns) that emerge through it&apos;s infinite iteration. Here are the rules:
        </p>
        <ol>
          <li>
        ...
        <p>
            ...
            equilibrium where the 2d world stands still in harmony. This, of course, may be deliberate in some implementations.
        </p>
        ...
        <p >
          Ok everyone put on your space hats; it&apos;s about to get wacky in here.
        </p>
        <p>
          The human mind is still a mystery to us, even though we all have one (at least most of us do hehe). We believe that we are these fantastically intelligent beings
          because we are constantly comparing ourselves to other creatures of the world.
        </p>
        <p>
          We should, in my opinion, stop for a second to consider that all the life we see on Earth
          is beautiful, rich in variety and deeply intricate. However... I want you to imagine
          this idea:
        </p>
        <QuestionComponent>
        ...
        <p>
          Luckily, <NewTabLink href="https://en.wikipedia.org/wiki/Noah%27s_Ark">Elon Musk is probably building an Ark</NewTabLink>
          &nbsp;to save all the biodiversity in the world. And, in the case where the world falls to bits (<i>because we 
