      ...
      >
        ...
        <MusicScrollDownMessage youtubeVideoEmbedId="UDVtMYqUAyw" start={261}>
          <p>
            ...
            &nbsp;desire to find a language to describe the fantastic patterns
            we see in nature.
          </p>
          <hr />
          <p>
          ...
          <p>
            First of all, you need to understand that the way creatures
            (patterns) emerge from Conway&apos;s Game of Life is far too similar
            to the way in which, said, biological &quot;creatures&quot;
            (patterns) emerge in our universe.
          </p>
          <p>
          ...
          <p>
            ...
            combination of cells in the shape of our DNA), then you could say
            that what we are experiencing in life is the result of a simple
            equation on an infinite scale and infinite complexity.
          </p>
          <p>
