      ...
      <div className="standard-page-margins standard-page-styling">
        ...
        <MusicScrollDownMessage youtubeVideoEmbedId="tVvG3X1pcQ8" start={40}>
          ...
          <p>
            ...
            create order, in our minds, so we can utilise reliable,
            deterministic logic. In the natural world, there is no such thing as
            a recursive call stack keeping track of recursive functions. Instead
            these natural recursive functions are better described as being
            painted onto the canvas of the cosmos and that painting is
            infinitely being imagined. However, we need a call stack on a
            machine so we can create order and this call stack is finite because
            memory on a machine is finite.
          </p>
          <p>
          ...
          <p>
            ...
            through brutal evolution, over an unimaginable period of time. We
            see wonderful recursive patterns in plants which are made up of
            cells, the same as all living things.
          </p>
          <p>
            <iframe
              width={width}
          ...
          <p>
            ...
            bassist) has a fantastic video on how rhythm can be the same as
            pitch.
          </p>
          <p>
          ...
          <div id="game-of-life">
            ...
            <p>
              I can&apos;t write about recursion and fractals without going off
              on an unrelated tangent about Conways Game of Life:
            </p>
            <p>
          ...
          <p>
            When using iteration, you can achieve the same result as recursion
            if you use an in-memory stack.
          </p>
          <p>
