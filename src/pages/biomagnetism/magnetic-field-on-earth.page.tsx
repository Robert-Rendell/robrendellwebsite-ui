...
export function MagneticFieldOnEarthPage() {
  ...
  return (
    <div className="standard-page-margins standard-page-styling">
      <h1><RobBackButton /> {SharedText.Biomagnetism.MagneticFieldOnEarth}</h1>
      <MusicScrollDownMessage youtubeVideoEmbedId="">
        <p>
          ...
          . The collective effect of magnetic fields produces 1 vast magnetic
          field going to the planet. This is the reason behind the magnetic
          fields on Earth.
        </p>
