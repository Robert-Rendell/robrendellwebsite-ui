...
export function MigratingBirdsPage() {
  ...
  usePageView(SharedRoutes.Biomagnetism.MigratingBirds);
  return (
      ...
      <MusicScrollDownMessage youtubeVideoEmbedId="tbONsqxGCHQ" start={13}>
        ...
        <div style={{ width: "100%", background: "white" }} className="centred">
          <p>
            <img
              width={width}
              src="https://cdn.the-scientist.com/assets/articleNo/38949/iImg/20738/462c987f-677d-4028-8e6d-11d3d854b249-bird-infograph.jpg"
            />
          </p>
        </div>
