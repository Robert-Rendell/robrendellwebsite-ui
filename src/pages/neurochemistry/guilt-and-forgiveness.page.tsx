  ...
  return (
    <div className="standard-page-margins standard-page-styling black-bg">
      ...
      <MusicScrollDownMessage youtubeVideoUrl="https://www.youtube.com/embed/FwkrrU2WYKg">
        ...
        <p>
          The law is always changing, keep an eye on it. Most of us don&apos;t
          get a say in what changes are made.
        </p>
        <p>
        ...
        <p>
          Many, many people have fought wars to make sure we could have
          democracy.
        </p>
        <p>Be bold; use your vote and your voice.</p>
        <hr />
        <p>
          Educate yourself and learn about UK Law in this rich book of
          knowledge:
          <br />
          <li>
        ...
        <p>
          As far as I know, the super-ego is a construct that your parents
          imprint on you as you are growing up as a child.
        </p>
        <p>
        ...
        <p>
          ...
          deficiency in emotional intelligence (should be required for
          managers). Though there was one huge mental blocker he simply could
          not overcome:
        </p>
        <QuestionComponent>Mental Blocker: Survival Instinct</QuestionComponent>
        <p>
          I believe this man was threatened by me (without me being threatening
          to him and actually, it was in fact him that verbally threatened me!).
        </p>
        <p>
          Forgiveness is so important because everyone makes mistakes and
          everyone deserves second changes.
        </p>
        <p>
        ...
        <hr />
        <p>
          Make room in your life for forgiveness, we are all human and we all
          make mistakes.
        </p>
        <p>
