...
export function SubconsciousPositiveReactionsPage() {
  ...
  return (
    <div className="standard-page-margins standard-page-styling black-bg-auto black-bg">
      ...
      <MusicScrollDownMessage youtubeVideoEmbedId="iCBL33NKvPA">
        ...
        <p>
          ...
          <u>current state of mind</u>, your <u>interpretation of reality</u>{" "}
          and your <u>reaction to events</u>.
        </p>
        <hr />
        <h2 className="centred">
        ...
        <ol>
          ...
          <li>
            <b>
              Repeat your behaviour so your subconscious learns them; meaning
              you can be positive even when tired.
            </b>
          </li>
        </ol>
        ...
        <ul>
          <li>
            &apos;Have a good day!&apos; - When you are finished in a dialog
            with another person, say &apos;Have a good day!&apos;;
          </li>
          <li>
          ...
          <li>
            Write down anything that made you happy today (eg. my lunch was
            tasty, I enjoyed my tea, getting outside was nice);
          </li>
          <li>
          ...
          <li>
            When you hear other people laughing, think this thought
        ...
        <hr />
        <p>
          Most importantly, you need to do these things regularly to build
          habits to train your subconscious.
        </p>
