  ...
  return (
    <div className="standard-page-margins standard-page-styling black-bg-auto black-bg">
      ...
      <h2 className="centred">
        <i>
        Heaven and hell... are they places of the afterlife?
        </i>
      </h2>
      <hr/>
      <p className="centred"><b>No</b> -- they are places on earth.</p>
      <p>
        I have experienced both, in life, and I believe it is a result of your <u>current state of mind</u>, your <u>interpretation of reality</u> and your <u>reaction</u> to events.
      </p>
      <hr/>
      <h2 className="centred">
        <i>
        What does &apos;State of Mind&apos; actually mean?
        </i>
      </h2>
      <hr/>
      <p>
        State of mind, in my opinion, is the current (metaphorical) shape of your unconscious mind (subconscious).
      </p>
      <p>
        Our brains are programs that are constantly being reworked by experience.
      </p>
      <p>
        Inputs arrive from the outside and the current state of the program (your mind) determines the output.
      </p>
      <p>
        The outputs, of your mind, are reactions to situations and events.
      </p>
      <hr/>
      <p>
        Crucially, I believe when the world feels upside down, it is a direct result of your mind being conditioned
        with a negative outlook. I call this <u>&apos;Subconscious Negative Reactions&apos;</u>.
      </p>
      <hr/>
      <h2 className="centred">
        <i>
        Practical ways to train your subconscious
        </i>
      </h2>
      <hr/>
      <p>
        So now you know the basics, let us go through a few strategies for a more optimistic / positive outlook:
      </p>
      <ol>
        <li>Take control of your reactions;</li>
        <li>Actively and deliberately react positively to events, even if it is very difficult;</li>
        <li><b>Repeat your behaviour so your subconscious learns them; meaning you can be positive even when tired.</b></li>
      </ol>
      ...
      <hr/>
      <p>Most importantly, you need to do these things regularly to build habits to train your subconscious.</p>
    </div>
  );
}