...
export function SelfLoveNotNarcissismPage() {
  return (<div className="standard-page-margins standard-page-styling">
    ...
    <hr/>
    <p>
        Self love is truly accepting your honest self.
    </p>
    <p>
        You first need to find your honest self by removing mental barriers that are holding you back:
      <ul>
        <li><u>Survival instinct</u>: by means of living life to the fullest;</li>
        <li><u>Ignorance</u>: by means of education;</li>
    ...
    <hr/>
    <p>
        If people spent more time understanding their own emotions, there would be a lot more love and kindness in the world.
    </p>
    <p className="centred">
        Be kind to yourself
    </p>
    ...
    <hr/>
    <h2 className="centred">
      <i>&quot;Smile, and the world smiles back. (... And if it doesn&apos;t... that smile is for you!)&quot;</i>
    </h2>
    <p className="centred">
