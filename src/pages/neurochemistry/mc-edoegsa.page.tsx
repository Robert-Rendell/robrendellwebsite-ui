  ...
  return (
    <div className="standard-page-margins standard-page-styling black-bg-auto black-bg">
      ...
      <i>
        ...
        <a href="https://www.psychologytoday.com/gb/blog/the-athletes-way/201211/the-neurochemicals-happiness">
      ...
      <hr />
      <p>
        The year is 2018 and I had a sudden epiphany after being bullied, daily,
        by my line manager (and his other managees) over a period of 11 months
        in my Edinburgh software job.
      </p>
      <p>
        I was so depressed with the job and just wanted to feel some happiness,
        so I thought about how I felt when I got my uni results.
      </p>
      <p>
      ...
      <p>
        ...
        <i>
          Do humans secrete chemicals from their skin when they are elated with
          happiness?
        </i>
      </p>
      <p>
        This is how I found Christopher Bergland&apos;s work on{" "}
        <a href="https://www.amazon.co.uk/Athletes-Way-Sweat-Biology-Bliss/dp/0312355866">
          The Athlete&apos;s Way
        </a>
