...
export function LearningAndGeneticCodePage() {
  ...
  return (
    <div className="standard-page-margins standard-page-styling black-bg-auto black-bg">
      ...
      <QuestionComponent questionText="Training your frontal brain, subconscious and finally, altering your
        genetic code."/>
      <p>To begin, it&apos;s worth noting I have no scientific knowledge of genetics.</p>
      <p>The point I want to get across from this page is this: that when you learn something so well,
        eventually, right down at the back of your skull in your brainstem, that learning turns into alterations in your genetic code.
      </p>
      <p>In order to describe this idea, you need to understand another conclusion I have come to...
        <u></u>
      </p>
      ...
      <p>
        ...
        is a perfect shape to represent the human brain.
      </p>
      <hr/>
      <p>
        The three separate brains, in my opinion, are the Cerebrum (up brain), the Cerebellum (down brain) and finally the Brainstem.
      </p>
      <p>
        Mapping these to the Holy Trinity (in the context of learning) we have:
        <ol>
          <li>Cerebrum = Father = Conscious mind = Development environment = Prototype code = Slow</li>
          <li>Cerebellum = Son = Subconscious mind = Staging environment = Refactored code = Fast </li>
          <li>Brainstem = Holy Ghost = Instinctual mind = Production environment = Live code = Lightning fast nervous system reflexes</li>
        </ol>
      </p>
      <hr/>
      <p>
        The reason this mapping works so well, in my mind, is because of the paternal/maternal instinct in all of us.
      </p>
      <p>
        The father (cerebrum) has to be the adult who creates order and logic for the other two.
        Learning begins here in your conscious mind.
      </p>
      <p>
      ...
      <p>
        You can actively influence your genetic programming (on a daily basis) and have a say in what traits, those inheriting from you, receive.
      </p>
    </div>
  );
}
