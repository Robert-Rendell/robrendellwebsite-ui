...
export function ZonesOfRegulationPage() {
  ...
  return (
    <div className="standard-page-margins standard-page-styling black-bg">
      <h1>
        <RobBackButton closeWindow /> {SharedText.Neurochemistry.ZonesOfRegulation}
      </h1>
      <p>
      ...
      <p>
        ...
        which caused us to seek out coping mechanisms.
      </p>
      <p>
        As you can imagine, this chart is not just useful for children... it is
        for emotionally aware adults too.
      </p>
      <p>
