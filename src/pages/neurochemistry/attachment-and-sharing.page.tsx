...
export function AttachmentAndSharing() {
  ...
  return (
    <div className="standard-page-margins standard-page-styling black-bg">
      ...
      <p>
        I haven&apos;t, personally, managed to remove it and I think it&apos;s
        only really buddhist monks (for example) that are truly able to achieve
        this.
      </p>
      <hr />
      <p>
        I do, however, believe that you can get close by doing something we are
        all familiar with: <u>sharing</u>!
      </p>
      <p>
        Share this project with your family and those who you think would
        benefit from this knowledge!
      </p>
      <p>
        I am sharing all my knowledge with you and I can also share a film
      ...
      <div className="centred">
        <img
          width={width / 3}
          src="https://m.media-amazon.com/images/I/81lAh-OgfgL._AC_SY445_.jpg"
        />
      </div>
    </div>
  );
