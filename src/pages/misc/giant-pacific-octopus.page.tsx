...
export function GiantPacificOctopusPage() {
  ...
  return (
    <div className="standard-page-margins standard-page-styling">
      ...
      <p>
        This{" "}
        <a href="https://www.fisheries.noaa.gov/alaska/science-data/octopus-research-alaska">
      ...
      <p>
        Self regulation:{" "}
        <a href="https://youtu.be/dKWssIQplw8">https://youtu.be/dKWssIQplw8</a>
      </p>
      <hr />
      <h2>References</h2>
      <ul>
        <li>
          <a href="https://octolab.tv/category/experiments">
            https://octolab.tv/category/experiments
          </a>
        </li>
        <li>
          <a href="https://youtu.be/dKWssIQplw8">
        ...
        <li>
          <a href="https://www.youtube.com/watch?v=IrdbENkylZM">
